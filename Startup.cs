...
using OrderService.Infrastructure.Middlewares;
using OrderService.Infrastructure.Filters;
...
using OrderService.Infrastructure.ModelBinder;
using Quartz;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (IsRedisEnable)
            {
                services.AddDataProtection()
                    .SetApplicationName(Configuration["App:Name"] ?? "OrderService")
